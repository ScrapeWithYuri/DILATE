...
if __name__ == '__main__':
    ...
    trainloader = DataLoader(dataset_train, batch_size=batch_size,shuffle=True, num_workers=3)
    testloader  = DataLoader(dataset_test, batch_size=batch_size,shuffle=False, num_workers=3)
    ...
    for ind in range(1,51):
        ...
        for net in nets:
            ...
            plt.xticks(range(0,N_input+N_output,2))
            plt.legend()
            k = k+1
